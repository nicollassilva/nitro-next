        ...
        <div className="h-10 shrink-0 px-1.5 py-1.25">
            <Border tintColor="#d8d8d8" className="h-full flex justify-center items-center px-1.25">
                <div className="flex gap-1">
                    <Button disabled={selectedFriendIds.length < 1} className="py-1.25! px-1.5!" {...tooltipHandlers('friendlist.tip.invite')} onClick={() => toggleWindow('friendlist_invite')}>
                        <NitroIcon icon="icon-room-invite" />
                    </Button>
                    <Button disabled={selectedFriendIds.length !== 1} className="py-1.25! px-1.5!" {...tooltipHandlers('friendlist.tip.home')}>
                ...
                <div className="flex-1 flex gap-1 justify-end">
                    ...
                    <Button disabled={selectedFriendIds.length < 1} className="py-1.25! px-1.5!" {...tooltipHandlers('friendlist.tip.remove')} onClick={() => toggleWindow('friendlist_remove_confirmation')}>
