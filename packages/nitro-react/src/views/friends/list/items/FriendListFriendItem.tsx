...
export const FriendListFriendItem = memo((props: FriendListFriendItemProps) => {
    ...
    const { relationshipDropdownId, setRelationshipDropdownId, toggleSelectedFriendId, isFriendSelected, tooltipHandlers } = useFriendsContext();
    
    const isSelected = isFriendSelected(friend.playerId);
