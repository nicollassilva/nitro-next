...
export const FriendListSearch = (props: FriendListSearchProps) => {
    ...
    return (
        <>
            <div className="h-4.5 shrink-0 bg-linear-to-b from-[#6b6b6b] from-50% to-[#555555] to-50% border-b flex justify-start items-center pt-px px-2 gap-1.5" onClick={ () => onTabChanged(tabName) }>
            ...
            { isActive() && <>
                <div className="flex flex-col flex-1 overflow-hidden border-b bg-[#b6b6b6]">
