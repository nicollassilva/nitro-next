...
export const InventoryView = () => {
    ...
    return (
        <>
            <Frame id="inventory" variant="3" className="absolute left-5 top-5 w-122.5 h-85.5" caption={getLocalizationValue('inventory.title')}>
                ...
                <TabContent>
                    {activeTab === 'furni' && <InventoryFurniView scrollVariant="3" />}
