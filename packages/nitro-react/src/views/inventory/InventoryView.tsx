...
import { Frame, TabContainerButton, TabContext } from "#base/components"
...
export const InventoryView = () => {
    ...
    return (
        <Frame variant="3" className="absolute left-5 top-5 w-112.5 h-62.5" caption={getLocalizationValue('inventory.title')}>
            <TabContext variant={'3'} data-name="tabs">
                <TabContainerButton variant="3" onClick={() => setActiveTab('furni')} aria-selected={activeTab === 'furni'}>
                    {getLocalizationValue('inventory.furni')}
                </TabContainerButton>
                <TabContainerButton variant="3" onClick={() => setActiveTab('pets')} aria-selected={activeTab === 'pets'}>
                    {getLocalizationValue('inventory.furni.tab.pets')}
                </TabContainerButton>
                <TabContainerButton variant="3" onClick={() => setActiveTab('bots')} aria-selected={activeTab === 'bots'}>
                    {getLocalizationValue('inventory.bots')}
                </TabContainerButton>
                <TabContainerButton variant="3" onClick={() => setActiveTab('badges')} aria-selected={activeTab === 'badges'}>
