...
import { useFriendsRequestsSelector, useWebSocketContext } from "#base/context";
import { useUserMessengerActions } from "#base/context/user";
import { useMessageListener } from "#base/hooks";

import { FriendRequestStateType } from "../../../nitro-shared/src/packets/incoming/FriendList/Data/FriendRequestStateType";
...
export const useMessengerHandler = () => {
    ...
    const friendRequests = useFriendsRequestsSelector()
