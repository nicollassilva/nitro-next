...
export const InfiniteGrid = <T,>(props: {
    ...
    const { items = [], itemWidth = 45, itemHeight = 45, overrideColumnCount = 0, itemRender, getKey } = props;
    ...
    return (
        <div className="flex size-full min-h-0 min-w-0 gap-0.5 p-1 overflow-hidden">
            <div
                ref={elementRef}
                className="min-h-0 min-w-0 flex-1 overflow-y-auto px-1.5 py-0.5 scrollbar-none [&::-webkit-scrollbar]:hidden">
                <div
                    ref={contentRef}
