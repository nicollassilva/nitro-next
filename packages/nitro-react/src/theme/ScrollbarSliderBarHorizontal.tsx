...
const scrollbarSliderBarHorizontalOverlayVariantsConfig = {
    variant: {
        // default
        '0': 'bg-(image:--scrollbarsliderbarhorizontal-0-default-grd-src) bg-position-[left_0px_top_5px] bg-size-[10px_7px] bg-no-repeat pixel-art active:bg-(image:--scrollbarsliderbarhorizontal-0-pressed-grd-src) active:bg-position-[left_0px_top_5px] active:bg-size-[10px_7px] active:[background-repeat:repeat_no-repeat] ',
        // black
        '1': 'bg-(image:--scrollbarsliderbarhorizontal-1-default-grd-src) bg-position-[left_0px_top_5px] bg-size-[10px_7px] bg-no-repeat pixel-art active:bg-(image:--scrollbarsliderbarhorizontal-1-default-grd-src) active:bg-position-[left_0px_top_5px] active:bg-size-[10px_7px] active:[background-repeat:repeat_no-repeat] ',
        // default
        '3': '',
        // default
        '100': '',
