...
const containerButtonVariantsConfig = {
    variant: {
        ...
        // black
        '4': '[border-image-source:var(--containerbutton-4-default-src)] [border-image-slice:6_6_7_6_fill] [border-image-width:6px_6px_7px_6px] [border-image-repeat:stretch] [image-rendering:pixelated] hover:[border-image-source:var(--containerbutton-4-hovering-src)] hover:[border-image-slice:6_6_7_6_fill] hover:[border-image-width:6px_6px_7px_6px] hover:[border-image-repeat:stretch] hover:[image-rendering:pixelated] active:[border-image-source:var(--containerbutton-4-pressed-src)] active:[border-image-slice:6_6_7_6_fill] active:[border-image-width:6px_6px_7px_6px] active:[border-image-repeat:stretch] active:[image-rendering:pixelated] aria-disabled:[border-image-source:var(--containerbutton-4-disabled-src)] aria-disabled:[border-image-slice:6_6_7_6_fill] aria-disabled:[border-image-width:6px_6px_7px_6px] aria-disabled:[border-image-repeat:stretch] aria-disabled:[image-rendering:pixelated]',
        // white
        '5': '[border-image-source:var(--containerbutton-4-default-src)] [border-image-slice:6_6_7_6_fill] [border-image-width:6px_6px_7px_6px] [border-image-repeat:stretch] [image-rendering:pixelated] hover:[border-image-source:var(--containerbutton-4-hovering-src)] hover:[border-image-slice:6_6_7_6_fill] hover:[border-image-width:6px_6px_7px_6px] hover:[border-image-repeat:stretch] hover:[image-rendering:pixelated] active:[border-image-source:var(--containerbutton-4-pressed-src)] active:[border-image-slice:6_6_7_6_fill] active:[border-image-width:6px_6px_7px_6px] active:[border-image-repeat:stretch] active:[image-rendering:pixelated] aria-disabled:[border-image-source:var(--containerbutton-4-disabled-src)] aria-disabled:[border-image-slice:6_6_7_6_fill] aria-disabled:[border-image-width:6px_6px_7px_6px] aria-disabled:[border-image-repeat:stretch] aria-disabled:[image-rendering:pixelated]',
        // green
        ...
        // plain
        '102': '[border-image-source:var(--button-102-default-src)] [border-image-slice:8_4_8_6_fill] [border-image-width:8px_4px_8px_6px] [border-image-repeat:stretch] [image-rendering:pixelated] active:[border-image-source:var(--button-102-pressed-src)] active:[border-image-slice:8_4_8_6_fill] active:[border-image-width:8px_4px_8px_6px] active:[border-image-repeat:stretch] active:[image-rendering:pixelated]',
        // unetched
        '103': '[border-image-source:var(--button-103-default-src)] [border-image-slice:8_4_8_6_fill] [border-image-width:8px_4px_8px_6px] [border-image-repeat:stretch] [image-rendering:pixelated] active:[border-image-source:var(--button-103-pressed-src)] active:[border-image-slice:8_4_8_6_fill] active:[border-image-width:8px_4px_8px_6px] active:[border-image-repeat:stretch] active:[image-rendering:pixelated]',
        // default
        '200': '[border-image-source:var(--button-200-default-src)] [border-image-slice:4_4_5_4_fill] [border-image-width:4px_4px_5px_4px] [border-image-repeat:stretch] [image-rendering:pixelated]',
    },
} as const;
...
const containerButtonVariants = cva('', { variants: containerButtonVariantsConfig, defaultVariants: { variant: '0' } });
...
interface ContainerButtonProps extends HTMLAttributes<HTMLDivElement>, ContainerButtonVariantProps {
    className?: string;
    tintColor?: string;
    defaultVariant?: string;
}

export const ContainerButton = forwardRef<HTMLDivElement, ContainerButtonProps>(
