...
const bubbleOverlayVariantsConfig = {
    variant: {
        // default
        '0': '[background-image:var(--bubble-0-default-spacer-src)] bg-position-[right_0px_bottom_0px] bg-size-[1px_1px] [background-repeat:no-repeat_no-repeat] [image-rendering:pixelated]',
        // default
        '7': '',
    },
} as const;
