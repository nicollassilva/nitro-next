...
const scrollbarSliderBarVerticalOverlayVariantsConfig = {
    variant: {
        // default
        '0': 'bg-(image:--scrollbarsliderbarvertical-0-default-grd-src) bg-position-[left_5px_top_0px] bg-size-[7px_10px] bg-repeat-y pixel-art active:bg-(image:--scrollbarsliderbarvertical-0-pressed-grd-src) active:bg-position-[left_5px_top_0px] active:bg-size-[7px_10px]',
        // black
        '1': 'bg-(image:--scrollbarsliderbarvertical-1-default-grd-src) bg-position-[left_5px_top_0px] bg-size-[7px_10px] bg-repeat-y pixel-art active:bg-(image:--scrollbarsliderbarvertical-1-default-grd-src) active:bg-position-[left_5px_top_0px] active:bg-size-[7px_10px]',
        // default
        '3': '',
        // default
        '100': '',
