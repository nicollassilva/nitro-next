...
const tabContentVariantsConfig = {
    variant: {
        ...
        // default
        '3': '[border-image-source:var(--tabcontent-3-default-src)] [border-image-slice:15_0_2_0_fill] [border-image-width:15px_0px_0px_0px] nine-slice-border pt-1.5 px-1.25 -mt-0.75 pb-0.5',
    },
} as const;
