...
const buttonThickVariantsConfig = {
    variant: {
        // default
        '0': 'sprite min-w-2 min-h-5.75 aria-disabled:pointer-events-none bg-(image:--buttonthick-0-default-src) bg-size-[100%_100%] hover:bg-(image:--buttonthick-0-hovering-src) hover:bg-size-[100%_100%] hover:bg-no-repeat  active:bg-(image:--buttonthick-0-pressed-src) active:bg-size-[100%_100%] active:bg-no-repeat  aria-disabled:bg-(image:--buttonthick-0-disabled-src) aria-disabled:bg-size-[100%_100%] aria-disabled:bg-no-repeat  pl-2 pt-1 pr-2 pb-1 text-[#000000] text-style-button-bold',
        // black
