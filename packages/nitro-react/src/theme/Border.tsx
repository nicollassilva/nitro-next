...
const borderVariantsConfig = {
    variant: {
        ...
        // light
        '103': '[background-image:var(--border-103-default-top-src),_var(--border-103-default-center-src),_var(--border-103-default-bottom-left-src),_var(--border-103-default-bottom-center-src),_var(--border-103-default-bottom-right-src)] [background-position:left_0px_top_0px,_left_0px_top_4px,_left_0px_bottom_0px,_left_4px_bottom_0px,_right_0px_bottom_0px] [background-size:100%_4px,_100%_calc(100%_-_4px_-_12px),_4px_12px,_calc(100%_-_4px_-_4px)_12px,_4px_12px] bg-no-repeat [image-rendering:pixelated]',
        // raised
